...
mobs.human = {
	...
	names = {
		"Jim", "Duncan", "Bill", "Tom", "Jamie", "Ian", "Lenny",
		"Dylan", "Ethan"
	},

	items = {
		--{item for sale, price, chance of appearing in trader's inventory}
		{"default:apple 10", "currency:minegeld_5 1", 10},
		{"farming:bread 10", "currency:minegeld_5 1", 5},
		{"default:clay 10", "currency:minegeld_5 1", 12},
		{"default:brick 10", "currency:minegeld_5 1", 17},
		{"default:glass 10", "currency:minegeld_5 2", 17},
		{"default:obsidian 10", "currency:minegeld_50 1", 50},
		{"default:diamond 1", "currency:minegeld_50 1", 40},
		{"farming:wheat 10", "currency:minegeld_5 ", 17},
		{"default:tree 5", "currency:minegeld_10 1", 20},
		{"default:stone 10", "currency:minegeld_5 1", 17},
		{"default:desert_stone 10", "currency:minegeld_5 1", 27},
		{"default:sapling 1", "currency:minegeld 2", 7},
		{"default:pick_steel 1", "currency:minegeld_10 2", 7},
		{"default:sword_steel 1", "currency:minegeld_10 2", 17},
		{"default:shovel_steel 1", "currency:minegeld_10 1", 17},
		{"default:cactus 2", "currency:minegeld_5 1", 40},
		{"moreores:silver_lump", "currency:minegeld_10 3", 50},
		{"moreores:mithril_lump", "currency:minegeld_10 3", 50},		
		{"default:papyrus 2", "currency:minegeld_5 1", 40},
		{"default:mese_crystal_fragment 1", "currency:minegeld_5", 90}
	}
}
...
mobs_npc.add_trader_list({
	...
	item_list = {
		{"default:gold_lump 2", "currency:minegeld_50 3"},
